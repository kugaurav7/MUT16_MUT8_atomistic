#!/bin/bash
#SBATCH --job-name=protein_charge_density  # Job name
...
#SBATCH --output=protein_charge_density.out           # Standard output log file
#SBATCH --error=protein_charge_density.err            # Standard error log file
...
for j in {0..99..10}; do
    for k in {0..99}; do
        ...
        if [ -d "$dir_path" ]; then
            ...
            python /mnt/home/gkumar/Mut16_Mut8_atomistic_project_analysis/protein_charge_density.py frame"$k".xtc &
