#!/bin/bash
#SBATCH --job-name=contact_map_calculation  # Job name
...
#SBATCH --output=contact_map_calculation.out           # Standard output log file
#SBATCH --error=contact_map_calculation.err            # Standard error log file
...
for j in {0..99..10}; do
    for k in {0..99}; do
        ...
        if [ -d "$dir_path" ]; then
            ...
            python /mnt/home/gkumar/Mut16_Mut8_atomistic_project_analysis/contact_map_calculation.py frame"$k".xtc &
