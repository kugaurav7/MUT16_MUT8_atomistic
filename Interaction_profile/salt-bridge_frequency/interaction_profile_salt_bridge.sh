#!/bin/bash
#SBATCH --job-name=interaction_profile_salt_bridge  # Job name
...
for j in {0..99..10}; do
    for k in {0..99}; do
        ...
        if [ -d "$dir_path" ]; then
            ...
            python /mnt/home/gkumar/Mut16_Mut8_atomistic_project_analysis/interaction_salt_bridge.py frame"$k".xtc &
