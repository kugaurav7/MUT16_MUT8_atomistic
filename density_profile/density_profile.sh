#!/bin/bash
#SBATCH --job-name=density_profile_analysis  # Job name
...
#SBATCH --output=density_profile_analysis.out           # Standard output log file
#SBATCH --error=density_profile_analysis.err            # Standard error log file
...
for j in {0..99..10}; do
    for k in {0..99}; do
        ...
        if [ -d "$dir_path" ]; then
            ...
            python /mnt/home/gkumar/Mut16_Mut8_atomistic_project_analysis/density_profile.py frame"$k".xtc &
